...
const contents: Record<string, Recording> = {
    ...
    "01HMQCVG7CPHCDD3YV3ZTYSDED": {
        ...
        script: "昨日の夕方はカレーを食べました 近くのカレー屋に行ったんですけど 閉店間際に行ったんですけど あれか試 作ゼミの後かな 試作ゼミ の後にお風呂に入ってラストオーダー ギリギリカレー屋に入って 確か ね キーマカレーとバターチキンカレー かなを頼んで食べましたと で なんか 前より辛くてバターチキンカレーって なんか結構甘い甘い 甘くはないけど辛くはないみたいな 感じの食べ物かなーって思ってたんですけど なんか昨日は特別辛くて ギリギリしましたね かなりびっくりした そうですね はい 昨日の夕食はそんな感じでした はーい",
        title: "昨日の夕食の話",
    },
};
