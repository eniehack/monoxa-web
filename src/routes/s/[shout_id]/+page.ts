...
const contents: Record<string, Recording> = {
	'01HME4VVMBMZCFJ27N7GR8W37X': {
		...
		script:
			'えーと今は2024年1月19日の17時ですえっと今はせっかくの動画を作ろうと思って 今なんかデモ音源みたいなものを撮っています うーんなんかまあ動画を作るのめんどくさいんで とりあえず録音でもしようかなという感じです うーんまあ喋る こと特にないかな あとはまあそんなところでしょうか まあなんか残り少ないですけど頑張りまーす っていうところで以上です',
		title: '動画を作るにあたって'
	},
	...
	'01HME4VVMBGGMG506BGYYFXZM3': {
		...
		script:
			'そうすると 先ほどと同じように このような形で さっきと同じような 録音されている状態になります そして もう1回話します',
		title: 'デモ'
	},
	'01HMQBCK83659S4F0AH37YEQJ9': {
		...
		script:
			'今は、2024年1月22日の9時12分です。 6時くらいまで作業してて、せっかくの動画を作っていて、めちゃくちゃ眠いし、 なんか、睡眠時間が足りない時の特有の腕の痛さというか、謎の筋肉痛みたいなのに襲われていますというか、があります 。 今、とりあえず後はデモを作って、時間を削るところをやらないとまずいので、その辺を今からやって、直せるかな、あんまり。 なんかあんまり、動画の内容が微妙だなという感じだったんですよね。 話す。ゼミの時は人がいたい、人に向かって説明するみたい な体で喋ってたんですけど、一人で話すみたいな感じになると、どうもうまく説明がいかない。 どうしたもんかなーっていう感じで すよね。 とりあえず頑張りますという感じです。',
		title: '動画提出の朝'
	},
	'01HMQCVG7CPHCDD3YV3ZTYSDED': {
		file: '/01HMQCVG7CPHCDD3YV3ZTYSDED.ogg',
		user: {
			id: 'eniehack',
			name: 'なかやばし'
		},
		script:
			'昨日の夕方はカレーを食べました 近くのカレー屋に行ったんですけど 閉店間際に行ったんですけど あれか試 作ゼミの後かな 試作ゼミ の後にお風呂に入ってラストオーダー ギリギリカレー屋に入って 確か ね キーマカレーとバターチキンカレー かなを頼んで食べましたと で なんか 前より辛くてバターチキンカレーって なんか結構甘い甘い 甘くはないけど辛くはないみたいな 感じの食べ物かなーって思ってたんですけど なんか昨日は特別辛くて ギリギリしましたね かなりびっくりした そうですね はい 昨日の夕食はそんな感じでした はーい',
		title: '昨日の夕食の話'
	}
};

export const load: PageLoad = ({ params }) => {
	const content = contents[params.shout_id];
